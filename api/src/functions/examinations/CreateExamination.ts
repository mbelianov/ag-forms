...
import { createEntity, ensureTableExists, getEntity } from '../../shared/storage/tableClient';
import { validateExamination } from '../../shared/validation/validation';
import { logExaminationCreated } from '../../shared/audit/auditService';
import { adjustCounter } from '../../shared/storage/counterService';
import { generateMRN } from '../../shared/mrn/mrnGenerator';
import { serializeExaminationData } from '../../shared/storage/examinationSerializer';
