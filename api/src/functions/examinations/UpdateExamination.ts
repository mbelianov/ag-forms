...
import { getEntity, updateEntity, ensureTableExists } from '../../shared/storage/tableClient';
import { validateExamination } from '../../shared/validation/validation';
import { logExaminationUpdated } from '../../shared/audit/auditService';
import { serializeExaminationData, deserializeExaminationData } from '../../shared/storage/examinationSerializer';
