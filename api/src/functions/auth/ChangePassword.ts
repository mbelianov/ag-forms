...
import { successResponse, errorResponse, unauthorizedResponse } from '../../shared/http/responseHelpers';
import { getTableClient, ensureTableExists } from '../../shared/storage/tableClient';
import { hashPassword, verifyPassword, validatePasswordStrength } from '../../shared/auth/passwordService';
import { logPasswordChanged } from '../../shared/audit/auditService';
