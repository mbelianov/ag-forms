...
import { requireAuth, canAccessResource, isDoctor } from '../../shared/auth/authMiddleware';
import { handleError } from '../../shared/http/errorHandler';
import { successResponse, unauthorizedResponse, forbiddenResponse, notFoundResponse } from '../../shared/http/responseHelpers';
import { ensureTableExists, getEntity, queryEntities, updateEntity } from '../../shared/storage/tableClient';
import { Patient, Examination, MRNLookup } from '../../types';
import { logPatientDeleted } from '../../shared/audit/auditService';
