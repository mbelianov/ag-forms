...
import { successResponse, unauthorizedResponse, forbiddenResponse, notFoundResponse, errorResponse, conflictResponse } from '../../shared/http/responseHelpers';
import { ensureTableExists, getEntity, updateEntity, deleteEntity, createEntity } from '../../shared/storage/tableClient';
import { Patient, BaseEntity } from '../../types';
import { validatePatient } from '../../shared/validation/validation';
import { logPatientUpdated } from '../../shared/audit/auditService';
