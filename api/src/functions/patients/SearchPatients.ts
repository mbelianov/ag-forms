...
import { successResponse, unauthorizedResponse, errorResponse } from '../../shared/http/responseHelpers';
import { ensureTableExists, queryEntities, getEntity } from '../../shared/storage/tableClient';
import { normalizePatientName, getSearchPartitionKey } from '../../shared/patients/patientUtils';
import { logAuditEvent } from '../../shared/audit/auditService';
