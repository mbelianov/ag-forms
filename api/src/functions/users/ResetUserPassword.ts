...
import {
    ...
    forbiddenResponse,
    notFoundResponse,
} from '../../shared/http/responseHelpers';
import { getTableClient, ensureTableExists } from '../../shared/storage/tableClient';
import { hashPassword, validatePasswordStrength } from '../../shared/auth/passwordService';
import { logPasswordResetByAdmin } from '../../shared/audit/auditService';
