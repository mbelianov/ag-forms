...
import { successResponse, errorResponse, unauthorizedResponse, forbiddenResponse } from '../../shared/http/responseHelpers';
...
import { validateUser } from '../../shared/validation/validation';
import { logUserCreated } from '../../shared/audit/auditService';
