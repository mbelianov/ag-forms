...
import { getTableClient, getEntity, ensureTableExists, updateEntity, deleteEntity } from '../../shared/storage/tableClient';
import { logUserDeleted, logExaminationsReassigned } from '../../shared/audit/auditService';
